<template>
  <view>
    ...
    <page-container :show="show" :overlay="false" position="bottom" :round="true" :close-on-slideDown="true"
      @afterleave="show=false">
      <view
        style="width:100%;height:60vh;background:#777;display: flex;flex-direction: column;align-items: center;padding-top: 10rpx;">
