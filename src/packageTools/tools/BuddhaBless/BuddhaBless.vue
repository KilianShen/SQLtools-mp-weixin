<template>
    <view class="page">
        ...
        <view :animation="state.animationData" class="add">
            +1
        </view>
    </view>
</template>
...
.woodenFish {
    ...
    background: #999;
    // 画图
    clip-path: polygon(60% 0%, 65% 1%, 70% 2%, 81% 7%, 85% 12%, 88% 15%,
            90% 19%, 91% 20%, 92% 22%, 93% 24%, 94% 26%, 95% 28%, 94% 30%,
            92% 32%, 88% 34%, 80% 36%, 70% 39%, 65% 40%, 60% 42%, 55% 43%,
            50% 45%, 45% 46%, 40% 48%, 35% 51%, 30% 55%, 29% 57%, 28.5% 59%,
            29% 60%, 30% 62%, 32% 64%, 34% 64%, 36% 63%, 40% 60%, 50% 53%,
            60% 47%, 65% 44%, 70% 42%, 80% 39%, 90% 36.5%, 95% 37%, 96% 38%,
            98% 42%, 99% 48%, 99.5% 60%, 98.5% 70%, 97% 75%, 95% 80%, 89% 89%,
            86% 92%, 75% 96%, 65% 98%, 60% 99%, 55% 99.5%, 50% 99%, 47% 98.5%,
            40% 97%, 30% 93.5%, 25% 91.5%, 20% 90%, 15% 88%, 10% 87%, 5% 88%,
            3% 86%, 2% 85%, 1% 82%, 0% 76%, 1% 74%, 3% 70%, 5% 67%, 8% 62%,
            12% 50%, 15% 43%, 20% 34%, 25% 25%, 30% 17%, 35% 12%, 40% 6%, 45% 3%,
            50% 2%, 60% 0%);
}
