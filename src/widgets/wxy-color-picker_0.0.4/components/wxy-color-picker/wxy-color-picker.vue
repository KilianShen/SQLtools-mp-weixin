<template>
  ...
  >
    ...
    <view class="t-box" :class="{ active: active }">
      ...
      <view class="t-alternative" v-if="windowHeight > 500">
        <view
...
export default {
  ...
  created() {
    ...
    if (this.spareColor.length !== 0) this.colorList = this.spareColor;
  ...
  methods: {
    ...
    inputColor(event, flag = "") {
      if (flag == "") return false;
      if (!["hex", "r", "g", "b", "a"].includes(flag)) return false;
      const rgba = JSON.parse(JSON.stringify(this.rgba));
      const hex = JSON.parse(JSON.stringify(this.hex));
      if (flag == "r" || flag == "g" || flag == "b" || flag == "a") {
        ...
        if (flag == "r") rgba.r = event.detail.value;
        if (flag == "g") rgba.g = event.detail.value;
        if (flag == "b") rgba.b = event.detail.value;
        if (flag == "a") rgba.a = event.detail.value;
